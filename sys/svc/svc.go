...
func init() {
	...
	err := svc.Migrate(
		...
		"INSERT INTO `sys_resource` VALUES (300000000000001, '2023-01-29 00:00:00.000', NULL, NULL, 0, 'sys', '系统设置', 1, 'Setting', '/sys', NULL, 100)",
		...
		"INSERT INTO `sys_resource` VALUES (300000000000005, '2023-01-29 00:00:00.000', NULL, NULL, 300000000000001, 'sysDept', '部门管理', 1, 'OfficeBuilding', '/sys/depts', NULL, 4)",
